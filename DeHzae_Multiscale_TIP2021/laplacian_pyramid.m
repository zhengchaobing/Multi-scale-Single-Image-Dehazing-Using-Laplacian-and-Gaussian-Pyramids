...
%   modified by Li Zhengguo on 4 May 2020

function [pyr, I_E_0] = laplacian_pyramid(I,nlev)
...
for l = 1:nlev - 1
    ...
    if l==1
        I_E_0 = upsample(I,odd,filter); %%store the smoothed image at the finest level
        pyr{l} = J - I_E_0;
    else
